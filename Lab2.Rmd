...
``` 
Results:
We removed `r4632 - 3270` rows from the original dataset due to illogical values or unknown species name, and modified 12 rows to reflect a data input error.  The five most frequently observed genera are Populus (824), Salix (789), Quercus (703), Fraxinus (467), and Acer (457).  P value > 2.2e-16  chisquared test of independence on these five genera vs site location. We reject the null hypothesis that frequency is independent of site location. 

Discussion:
The chisquared test shows us what is visible in figure 1: The Consumne River Preserve and the Sacramento Red River Bluff sites had more frequent occurances of the 5 most frequent species than NASO and HOWY 
