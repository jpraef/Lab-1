...
p1 <- ggplot(tree_data , aes(x = zval)) + geom_histogram() + theme(axis.text.x =  element_blank()) + labs(title = "Tree Heights (m)",size = .5)

p2 <- ggplot(tree_data , aes(x = rval)) + geom_histogram() + theme(axis.title.y = element_blank()) + labs(title = "Crown Radii (m)",size = .5)
...
p5 <- ggplot(data = tree_data, aes(x = zval, y = rval)) + geom_point(position = "jitter", size = .5) + geom_smooth(method = glm)+ labs( title = "Tree Height vs. Crown Radii", x = "Tree Height (m)", y = "Crown Radii (m)",size = .5)

p6 <- ggMarginal(p5, type = "boxplot")

p7 <- ggplot(data = tree_data, aes(x = zval, y = rval)) + geom_point(position = "jitter", size = .5) + geom_smooth(method = glm) + scale_x_log10() + labs( title = "Transformed Tree Height vs. Crown Radii", x = "Tree Height log10(m)", y = "Crown Radii log10(m)",size = .5)
...
p9 <- ggplot(tree_data_limit , aes(x = zval)) + geom_histogram() + theme(axis.text.x =  element_blank()) + labs(title = "Tree Heights (m)",size = .5)

p10 <- ggplot(tree_data_limit , aes(x = rval)) + geom_histogram() + theme(axis.title.y = element_blank()) + labs(title = "Crown Radii (m)",size = .5)
...
#Comparison of observation locations, with color indicating height and dot size indicating crown radii
 ggplot(tree_data, aes(x = xval, y = yval)) + labs(title = "Position of Sierra Nevada Conifers, LiDAR Scan", x = NULL, y = NULL,size = .5) + theme_bw() + geom_point(aes(size = rval, color = zval), alpha = 9/10, position = "jitter")
                                                                
 ggplot(tree_data_limit, aes(x = xval, y = yval)) + labs(title = "Position of Sierra Nevada Conifers, LiDAR Scan, Subset", x = NULL, y = NULL,size = .5) + theme_bw()  + geom_point(aes(size = rval, color = zval), alpha = 9/10, position = "jitter")
...
p13 <- ggplot(data = tree_data, aes(x = zval, y = rval)) + geom_point(position = "jitter", size = .5) + geom_smooth(method = lm)+ labs( title = "Tree Height vs. Crown Radii", x = "Tree Height (m)", y = "Crown Radii (m)",size = .5)
