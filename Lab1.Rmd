...
```{r}
library(ggplot2)
tree_gg <- ggplot(tree_data, aes(x = xval, y = yval)) + labs(title = "Position of Sierra Nevada Conifers, LiDAR Scan", x = NULL, y = NULL) + theme_bw()
tree_gg + geom_point(size = .01, color = "forest green", alpha = 9/10, position = "jitter")
```
