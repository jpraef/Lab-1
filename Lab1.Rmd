...
```
Histograms of tree height and crown radii
The data do not appear to meet the assumptions of normality; tree height and crown radii are skewed right.

By log transforming heigth and radii we can better meet normality assumptions.
...
Both Spearman's rho and Pearson's product moment correlation show statistical significance (p-value < 2.2e-16 and < 2.2e-16, respectively). We reject the null hypothesis of no correlation between tree height and crown radii.  R- values are .623 and .598 respectively.
