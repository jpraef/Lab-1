...
summary(annaa("HOWY","Acer"))$r.squared
summary(annaa("HOWY","Populus"))$r.squared
summary(annaa("HOWY","Fraxinus"))$r.squared
summary(annaa("HOWY","Quercus"))$r.squared
summary(annaa("HOWY","Salix"))$r.squared
summary(annaa("CORP","Acer"))$r.squared
summary(annaa("CORP","Populus"))$r.squared
summary(annaa("CORP","Fraxinus"))$r.squared
summary(annaa("CORP","Quercus"))$r.squared
summary(annaa("CORP","Salix"))$r.squared
summary(annaa("SRRB","Acer"))$r.squared
summary(annaa("SRRB","Populus"))$r.squared
summary(annaa("SRRB","Fraxinus"))$r.squared
summary(annaa("SRRB","Quercus"))$r.squared
summary(annaa("SRRB","Salix"))$r.squared
summary(annaa("NASO","Acer"))$r.squared
summary(annaa("NASO","Populus"))$r.squared
summary(annaa("NASO","Fraxinus"))$r.squared
summary(annaa("NASO","Quercus"))$r.squared
summary(annaa("NASO","Salix"))$r.squared
