...
g1 <- ggplot(data = rd_lab4,aes(x = Woody_DBH_cm, y = Woody_Height_cm, color = Genus)) + geom_point() + theme_minimal() + labs(title = "", x = "DBH, cm", y = "Height, cm") + theme(legend.position = c(0,1), legend.justification = c(0,1))
...
g2 <- ancovaplot(Woody_Height_cm ~ Woody_DBH_cm + Genus, data = rd_lab4, title = "Woody_Height_cm ~ Woody_DBH_cm + Genus")
g3 <- ancovaplot(Woody_Height_cm ~ Woody_DBH_cm * Genus, data = rd_lab4, title = "Woody_Height_cm ~ Woody_DBH_cm * Genus")
