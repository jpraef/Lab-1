...
```{r}
grid.arrange(g1,g2,g3, ncol = 3, top = "Height ~ DBH, Height ~ DBH + Genus, Height ~ DBH * Genus", bottom = "Figure 1: Scatterplot of Height vs DBH, ANCOVA plots by genus with genus as single terms and genus as interaction terms.")
```
